...
@Component({
  ...
  templateUrl: './add-cargo-loading-method.component.html',
  styleUrls: ['./add-cargo-loading-method.component.scss'],
...
export class AddCargoLoadingMethodComponent {
  edit: boolean = false;
  ...
  constructor(
    ...
    private _cargoloadingService: CargoLoadingMethodService,
