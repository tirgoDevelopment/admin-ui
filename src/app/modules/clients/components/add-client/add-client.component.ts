...
export class AddClientComponent {
  ...
  form: FormGroup = new FormGroup({
    ...
    password: new FormControl('', this.edit ? null : [Validators.required, Validators.maxLength(16), Validators.minLength(8), Validators.pattern('^[a-zA-Z]+\d{1,5}$|^\d{1,5}[a-zA-Z]+$')]),
